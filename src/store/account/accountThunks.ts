...
import { sendAccountStart, sendAccountSuccess, sendAccountFailure, updateAccountStart, updateAccountSuccess, updateAccountFailure, getAccountsStart, getAccountsSuccess, getAccountsFailure } from './accountSlice';
...
export const fetchAccountsThunk = (): ThunkAction<void, RootState, unknown, Action<string>> => async (dispatch: any) => {
  try {
